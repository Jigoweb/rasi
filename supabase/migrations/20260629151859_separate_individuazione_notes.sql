-- Keep programmazione notes and individuazione notes independent.
-- Fresh individuazione runs should only store the notes explicitly provided at
-- launch time, without inheriting campagne_programmazione.descrizione.
