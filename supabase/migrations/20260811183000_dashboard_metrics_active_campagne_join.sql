-- Keep dashboard "campagne attive" aligned with attention queue:
-- only count individuazione runs whose parent programmazione is still in_corso.
-- After finalize, programmazione becomes individuata while the run may linger as in_corso.
